...
<style>
    ...
    main {
        ...
        background: url("https://www.transparenttextures.com/patterns/axiom-pattern.png"), radial-gradient(rgb(131, 111, 255), rgb(33, 25, 81));
    }

    h1 {
        position: relative;

        font-family: Kollektifh, sans-serif;
        font-size: 16rem;
        color: white;
