...
export const breizhIle: Project = {
    ...
    image: "/images/projects/breizh-ile/1.webp",
    alt: "Mon projet",
    ...
    detail: {
        ...
        image1: "/images/projects/breizh-ile/1.webp",
        image2: "/images/projects/breizh-ile/2.webp",
        image3: "/images/projects/breizh-ile/3.webp",
        image4: "/images/projects/breizh-ile/4.webp",
...
export const connect4: Project = {
    ...
    image: "/images/projects/connect4/5.webp",
    alt: "Mon projet",
    ...
    detail: {
        ...
        image1: "/images/projects/connect4/1.webp",
        image2: "/images/projects/connect4/2.webp",
        image3: "/images/projects/connect4/3.webp",
        image4: "/images/projects/connect4/4.webp",
...
export const LLTK: Project = {
    ...
    link: "/projects/LLTK",
    image: "/images/projects/LLTK/1.webp",
    alt: "Mon projet",
    file: "",
    ...
    detail: {
        ...
        image1: "/images/projects/LLTK/1.webp",
...
export const outilInfoSchema: Project = {
    ...
    image: "/images/projects/outil-info-schema/1.webp",
    alt: "Mon projet",
    file: "",
    tags: [realiseTag, optimiserTag, administrerTag, conduireTag, collaborerTag],
    detail: {
        context: "Dans le cadre de mon alternance, j'ai été chargé de développer une application web interne pour mon entreprise. Cette application avait pour objectif de permettre à tous les salariés d'accéder facilement aux données stockées dans les bases SQL. Les utilisateurs devaient pouvoir consulter les types de colonnes, exporter les tables au format PDF / Excel, et effectuer des comparaisons entre des schémas de bases de données (par exemple, comparer un environnement de développement avec un environnement de production).",
        problematic: "Mon objectif était donc de créer un outil fonctionnel et intuitif répondant aux besoins de gestion et d’analyse des bases de données, de déployer cet outil en production et d'assurer une adoption réussie de l'outil en accompagnant les équipes.",
        realisation: "Pour développer l’application, j’ai utilisé des technologies adaptées pour le front-end et le back-end, intégrant des fonctionnalités comme l’export PDF des tables SQL et la comparaison des schémas. L’outil a été testé en phase bêta auprès des développeurs, ce qui m’a permis de recueillir leurs retours, corriger les bugs, et optimiser l’interface utilisateur. J’ai également géré la configuration, le déploiement en production, et documenté le processus pour simplifier son adoption. Enfin, j’ai accompagné les utilisateurs en animant des présentations pour expliquer son fonctionnement.",
        conclusion: "L’outil a été déployé avec succès, améliorant la productivité des équipes de développement grâce à des fonctionnalités clés comme l’export PDF et la comparaison des schémas. Ces innovations ont simplifié l’analyse et la gestion des bases de données, avec des retours positifs.",
        image1: "/images/projects/outil-info-schema/1.webp",
        image2: "/images/projects/outil-info-schema/2.webp",
        image3: "/images/projects/outil-info-schema/3.webp",
        image4: "/images/projects/outil-info-schema/4.webp",
        collaborators: [],
...
export const teamBuilding: Project = {
    ...
    image: "/images/projects/team-building/2.webp",
    alt: "Mon projet",
    ...
    detail: {
        ...
        image1: "/images/projects/team-building/1.webp",
        image2: "/images/projects/team-building/2.webp",
        image3: "/images/projects/team-building/3.webp",
        image4: "/images/projects/team-building/4.webp",
...
export const automatisation: Project = {
    ...
    image: "/images/projects/automatisation/5.webp",
    alt: "Mon projet",
    ...
    detail: {
        ...
        image1: "/images/projects/automatisation/1.webp",
        image2: "/images/projects/automatisation/2.webp",
        image3: "/images/projects/automatisation/3.webp",
        image4: "/images/projects/automatisation/4.webp",
