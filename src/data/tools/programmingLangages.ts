...
const c: Tool = {
	image: "/images/tools/C-wikipedia.svg",
...
const csharp: Tool = {
	image: "/images/tools/Csharp-wikipedia.svg",
	alt: "Langage de programmation C#",
	description: "Langage de programmation C#",
...
const java: Tool = {
	image: "/images/tools/java-wallpapers.com.png",
...
const python: Tool = {
	image: "/images/tools/python-cleanpng.com.png",
...
const bash: Tool = {
	image: "/images/tools/bash-notos.fr.png",
...
const visualStudioCode: Tool = {
	image: "/images/tools/VisualStudioCode-wikipedia.png",
...
const jetBrainsSoftware: Tool = {
	image: "/images/tools/jetbrains-wikipedia.png",
...
const godot: Tool = {
	image: "/images/tools/godot-godotengine.org.png",
...
const git: Tool = {
	image: "/images/tools/git-git-scm.com.png",
